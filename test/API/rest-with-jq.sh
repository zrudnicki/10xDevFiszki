...
# On Windows with WSL: sudo apt install jq
# On macOS: brew install jq

# 1. First obtain the token (using silent mode with -s)
...
# 2. Extract the access token using jq (more reliable for JSON parsing)
