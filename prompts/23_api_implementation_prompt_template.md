...
<implementation_plan>
{{endpoint-implementation-plan}} <- zamień na referencję do planu implementacji odpowiedni dla obecnie opisywanego endpoint api @api-...-implementation-plan.md
</implementation_plan>

<types>
{{types}} <- zamień na referencje do definicji typów @database.types.ts
</types>

<implementation_rules>
{{backend-rules}} <- zamień na referencje do Rules for AI dla backendu @api-supabase-astro-init.mdc @shared.mdc, @backend.mdc, @astro.mdc
</implementation_rules>
