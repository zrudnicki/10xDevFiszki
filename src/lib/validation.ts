...
// Collections API Validation Schemas
...
export const CreateCollectionSchema = z.object({
  name: z.string().min(1, "Collection name is required").max(250, "Collection name must not exceed 250 characters").trim(),
  description: z.string().optional(),
});

export const UpdateCollectionSchema = z.object({
  name: z.string().min(1, "Collection name is required").max(250, "Collection name must not exceed 250 characters").trim().optional(),
  description: z.string().optional(),
});
